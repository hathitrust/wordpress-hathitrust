<?php
	...
	function pg_enqueue_site_files() {
		...
		if ( 'local' === wp_get_environment_type() ) {
			...
			wp_enqueue_style( 'site-styles', get_template_directory_uri() . '/style.css', array( 'site-fonts' ), filemtime( get_template_directory() . '/style.min.css' ) );
		} else {
		...
		if ( is_front_page() && 'local' === wp_get_environment_type() ) {
			wp_enqueue_style( 'home-styles', get_template_directory_uri() . '/home.css', array( 'site-fonts', 'site-styles' ), filemtime( get_template_directory() . '/home.min.css' ) );
		...
		if ( 'local' === wp_get_environment_type() ) {
			...
			wp_enqueue_script( 'site-scripts', get_template_directory_uri() . '/js/scripts.js', array('firebird-scripts'), filemtime( get_template_directory() . '/js/scripts.js' ), TRUE );
		} else {
			//need min version of firebird
			wp_enqueue_script( 'firebird-scripts', 'https://hathitrust-firebird-common.netlify.app/assets/main.js', array(), false, false);
			wp_enqueue_script( 'site-scripts', get_template_directory_uri() . '/js/scripts.min.js', array('firebird-scripts'), filemtime( get_template_directory() . '/js/scripts.min.js' ), TRUE );
		}
