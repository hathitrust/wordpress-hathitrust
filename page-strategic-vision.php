...
<div class="strategic-vision-banner" style="grid-area:2/1">
    ...
    <button class="btn btn-outline-light">Download the Strategic Vision</button>
</div>
<div class="twocol" style="grid-area:3/1">
	...
	<div class="twocol-main" id="page-content">
		<div class="mainplain" id="strategic-vision">
            ...
            <p class="bold">While described separately and in numerical order, these Directions and Objectives are not listed in priority order, nor are they discretely separable or sequential in practice. They are overlapping, connected, and part of a symbiotic whole.</p>
            <p>ACCORDIONS</p>
            <p>IMAGE</p>
